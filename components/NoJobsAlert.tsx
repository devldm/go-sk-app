...
export default function DetailsPill() {
  return (
    <View className="justify-around w-11/12 self-center  p-4 h-2/5 bg-neutral-900 rounded-md shadow-lg border-2 border-neutral-700 ">
      <Text className="text-white text-3xl">Sorry, no jobs right now!</Text>
