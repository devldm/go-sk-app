...
export default function JobsPreview({ job }: { job: Job }) {
  ...
  return (
    <View className="border-2 border-neutral-700 rounded-md w-11/12 self-center mb-2 bg-neutral-100 dark:bg-neutral-900">
      <View className="rounded-md w-full self-center bg-neutral-100 dark:bg-neutral-900 p-2">
        <View>
          <Text className="text-2xl  dark:text-white font-bold  w-11/12 overflow-ellipsis">
            {job.job_title}
          </Text>
        ...
        <View className="flex-row justify-between">
          <Text className=" dark:text-white text-lg">{job.company_name}</Text>
        </View>
      </View>
